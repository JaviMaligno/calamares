...
\texttt{javier.aguilar@sapira.ai}. Draft. Computational verification scripts
for every numerical claim, together with the full proofs and the adversarial
verification reports cited in the appendix, are available in the
