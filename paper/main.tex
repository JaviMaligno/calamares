...
placement obliviousness. Complete proofs for every statement of this
...
template -- with $S$ a pair or a triple -- for $\omega<0.9626$ with one
extra occupant under arbitrary hole occupancy, for $\omega<0.624$ and
$\omega<0.896$ with two and three, and for all $\omega$ with four or more.
...
$\omega\ge0.624$; $j=3$, $\omega\ge0.896$), a
quantitative ``gap lemma'' (small rings against the geometric wall; tiny
$\sigma_2$), profiles of four or more pieces beyond the reduction branch
(and $k\ge3$ with extra occupants beyond it), and the second battle where
$u$ is the pan itself. Each statement in
...
$\omega\ge0.896$), a quantitative gap lemma
(small rings against the double-pocket wall; tiny $\sigma_2$), reinsertion
profiles of four or more pieces beyond the reduction branch, and the case
where $u$ is the pan.
\end{openproblem}
